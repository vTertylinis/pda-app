export const CATEGORIES = [
  {
    ...
    items: [
      ...
      { name: 'Nescafe', price: 3.5 },
      { name: 'Nescafe φραπέ', price: 3.5 },
      { name: 'Latte', price: 4.5 },
      { name: 'Καφές φίλτρου', price: 3.5 },
      { name: 'Κακάο', price: 3 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: '3 cents Pink', price: 4.5 },
      { name: '3 cents Ginger', price: 4.5 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'KYOTO', price: 10 },
      { name: 'El Sol (Mocktail)', price: 7 },
      { name: 'Mojito Green Apple (Mocktail)', price: 7 },
