export const CATEGORIES = [
  ...
  {
    name: 'Καθαρά Δευτέρα Μενού',
    items: [
      { name: 'Μύδια Αχνιστά', price: 10 },
      { name: 'Σουπιές με Χόρτα', price: 14 },
      { name: 'Σουπιές Στιφάδο', price: 14 },
      { name: 'Χταπόδι Φάβα', price: 14 },
      { name: 'Χταπόδι Θαλασσινά Κοφτό Μακαρόνι', price: 18 },
      { name: 'Θράψαλα Τηγανιτά', price: 12 },
      { name: 'Γαρίδες Σαγανάκι', price: 14 },
      { name: 'Γαρίδες Ψητές με Λαδολέμονο', price: 14 },
      { name: 'Γαριδομακαρονάδα', price: 18 },
      { name: 'Σκουμπρί Καπνιστό', price: 7 },
      { name: 'Γίγαντες στο Πήλινο', price: 5 },
      { name: 'Ταραμοσαλάτα', price: 4.5 },
      { name: 'Πατατοσαλάτα', price: 5 },
      { name: 'Πικάντικη', price: 5 },
      { name: 'Λαγάνα (Κουβέρ)', price: 1.5 },
      { name: 'Επιδόρπιο Χαλβάς', price: 0.01 },
    ],
  }
];
