export const CATEGORIES = [
  ...
  },
  {
    name: 'Μενού 25ης',
    items: [
      { name: 'Μπακαλιάρος Τηγανιτός', price: 14 },
      { name: 'Μπακαλιάρος Νταβά (Αγιορίτικος)', price: 14 },
      { name: 'Καλαμαράκια Τηγανητά', price: 12 },
      { name: 'Σουπιές Με Χόρτα', price: 14 },
      { name: 'Γαρίδες Σαγανάκι', price: 14 },
      { name: 'Μύδια Αχνιστά', price: 10 },
      { name: 'Μύδια Σαγανάκι', price: 14 },
      { name: 'Γίγαντες', price: 5 },
      { name: 'Τονολακέρδα', price: 8 },
      { name: 'Καυτερές Πιπερίες', price: 4.5 },
      { name: 'Πατάτες με Μανιτάρια', price: 5 },
      { name: 'Πατάτες Τηγανιτές', price: 5 },
      { name: 'Ταραμάς', price: 4.5 },
      { name: 'Πατατοσαλάτα', price: 5 },
      { name: 'Πικάντικη', price: 5 },
      { name: 'Αγγουροντομάτα', price: 6 },
      { name: 'Χωριάτικη', price: 8.5 },
      { name: 'Φέτα', price: 5 },
      { name: 'Κουβέρ', price: 1.5 },
    ],
  }
